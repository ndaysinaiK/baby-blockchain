    ...
    return (
        ...
        <div className='flex flex-col align-center justify-center p-6'>
            ...
            <div className='flex items-center justify-center h-5'>
                ...
                {loading &&
                    <p className='dark:text-white'><b className='flex items-center justify-center'>Loading .....</b>
                    </p>}

            </div>

            {!loading &&
                <div><h1 className='dark:text-white text-2xl mb-5'>Distributed Ledger, the only source of truth.</h1>
                </div>}
